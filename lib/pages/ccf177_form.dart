...
class CCF177FormPage extends StatefulWidget {
  const CCF177FormPage({super.key});

  @override
  State<CCF177FormPage> createState() => _CCF177FormPageState();
}

class _CCF177FormPageState extends State<CCF177FormPage> {
  // ============================================================
  ...
  final Map<String, String?> coffrePassager = {
    ...
    "5 tuyaux de 70": null,
    "2 tuyaux de 45": null,
    "1 réduction 70/45 GFR": null,
  };

  final Map<String, String?> trousseOutils = {
    "1 Tournevis TORX 20/30": null,
    "1 Tournevis plat": null,
    "1 Tournevis double cruciforme": null,
    "1 Manche pour tournevis": null,
    "1 Marteau": null,
    "1 Clé oeil 16": null,
    "1 Clé oeil 18": null,
    "1 Clé oeil 22": null,
    "1 Clé oeil 24": null,
    "1 Clé plate 8/10": null,
    "1 Clé plate 11/13": null,
    "1 Clé plate 12/13": null,
    "1 Clé plate 12/14": null,
    "1 Clé plate 13/15": null,
    "1 Clé plate 16/18": null,
    "1 Clé plate 17/19": null,
    "1 Clé plate 21/24": null,
    "1 Clé plate 22/24": null,
    "1 Clé plate 27/32": null,
    "1 Clé plate 30": null,
    "1 Clé plate 36": null,
    "1 Pince multi-prise": null,
  };
  ...
  final Map<String, String?> interieurCabine = {
    ...
    "2 Tricoises": null,
    "2 Cales en fer": null,
    "1 Triangle signalisation": null,
    "1 Manuel d'utilisation CCF": null,
    "1 Clé pour les roues": null,
    "1 Bouchon de 45": null,
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("CCF 177 enregistré ✅")),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("CCF 177")),
