...
class RetourFdfCcf177FormPage extends StatefulWidget {
  const RetourFdfCcf177FormPage({super.key});

  @override
  State<RetourFdfCcf177FormPage> createState() => _RetourFdfCcf177FormPageState();
}

class _RetourFdfCcf177FormPageState extends State<RetourFdfCcf177FormPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('vehicle_checks_submissions').add({
        'formId': 'RETOUR_FDF_CCF_177',
        'formTitle': 'Retour FDF CCF 177',
        'vehicle': 'CCF 177',
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Retour FDF CCF 177 enregistré ✅')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('VERIFICATION RETOUR FDF CCF 177')),
                    ...
                    child: Column(
                      children: [
                        ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/images/formulaires/pre_filtre_ccf177.jpg.jpg',
                            fit: BoxFit.cover,
                          ),
                        ),
