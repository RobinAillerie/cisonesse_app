// lib/pages/divers/divers_docs_data.dart
    ...
    return [
      ...
      DocNode.category(
        ...
        items: const [
          ...
          PdfItem(title: "Numéros bouteilles air", assetPath: "assets/pdfs/supports_incendie/Numéros bouteilles air.pdf"),
      ...
      DocNode.category(
        ...
        items: const [
          ...
          PdfItem(title: "XABCDE", assetPath: "assets/pdfs/supports_suap/XABCDE.pdf"),
          PdfItem(title: "06 types de plaies", assetPath: "assets/pdfs/supports_suap/06 types de plaies.pdf"),
        ],
      ),
      DocNode.category(
        title: "Supports FDF",
        ...
        items: const [
          ...
          PdfItem(title: "Engagement CCF SEUL", assetPath: "assets/pdfs/supports_fdf/Engagement CCF SEUL.pdf"),
          PdfItem(title: "Carte réseaux tactiques", assetPath: "assets/pdfs/supports_fdf/Carte réseaux tactiques.pdf"),
        ],
      ),
      DocNode.category(
